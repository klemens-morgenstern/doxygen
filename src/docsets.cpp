...
{
  // -- get config options
  QCString projectName = DOXY_CONFIG_GET_STRING("PROJECT_NAME");
  if (projectName.isEmpty()) projectName="root";
  QCString bundleId = DOXY_CONFIG_GET_STRING("DOCSET_BUNDLE_ID");
  if (bundleId.isEmpty()) bundleId="org.doxygen.Project";
  QCString feedName = DOXY_CONFIG_GET_STRING("DOCSET_FEEDNAME");
  if (feedName.isEmpty()) feedName="FeedName";
  QCString publisherId = DOXY_CONFIG_GET_STRING("DOCSET_PUBLISHER_ID");
  if (publisherId.isEmpty()) publisherId="PublisherId";
  QCString publisherName = DOXY_CONFIG_GET_STRING("DOCSET_PUBLISHER_NAME");
  if (publisherName.isEmpty()) publisherName="PublisherName";
  QCString projectNumber = DOXY_CONFIG_GET_STRING("PROJECT_NUMBER");
  if (projectNumber.isEmpty()) projectNumber="ProjectNumber";

  // -- write Makefile
  {
  QCString mfName = DOXY_CONFIG_GET_STRING("HTML_OUTPUT") + "/Makefile";
  ...
  // -- write Info.plist
  {
  QCString plName = DOXY_CONFIG_GET_STRING("HTML_OUTPUT") + "/Info.plist";
  QFile plist(plName);
  ...
  // -- start Nodes.xml
  QCString notes = DOXY_CONFIG_GET_STRING("HTML_OUTPUT") + "/Nodes.xml";
  ...
  QCString tokens = DOXY_CONFIG_GET_STRING("HTML_OUTPUT") + "/Tokens.xml";
