...
void Qhp::initialize()
{
  ...
  ..
  */
  QCString nameSpace       = DOXY_CONFIG_GET_STRING("QHP_NAMESPACE");
  QCString virtualFolder   = DOXY_CONFIG_GET_STRING("QHP_VIRTUAL_FOLDER");
  ...
  // Add custom filter
  QCString filterName = DOXY_CONFIG_GET_STRING("QHP_CUST_FILTER_NAME");
  if (!filterName.isEmpty())
  {
    ...
    QStringList customFilterAttributes = QStringList::split(QChar(' '), DOXY_CONFIG_GET_STRING("QHP_CUST_FILTER_ATTRS"));
  ...
  QStringList sectionFilterAttributes = QStringList::split(QChar(' '),
      DOXY_CONFIG_GET_STRING("QHP_SECT_FILTER_ATTRS"));
...
void Qhp::finalize()
{
  ...
  QCString fileName = DOXY_CONFIG_GET_STRING("HTML_OUTPUT") + "/" + getQhpFileName();
  QFile file(fileName);
...
QCString Qhp::getFullProjectName()
{
  ...
  QCString versionText = DOXY_CONFIG_GET_STRING("PROJECT_NUMBER");
