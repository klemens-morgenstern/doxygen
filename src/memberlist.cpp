...
{
  static bool sortConstructorsFirst = DOXY_CONFIG_GET_BOOL("SORT_MEMBERS_CTORS_1ST");
...
// apparently necessary to get this to show up in declarations section?
        ...
        case MemberType_Define:      if (DOXY_CONFIG_GET_BOOL("EXTRACT_ALL") || 
                                         md->argsString() || 
        ...
        case MemberType_Enumeration: 
          {
            ...
            if (enumVars==0 && !hideUndocMembers) // show enum here
            {
              ...
              if (!md->briefDescription().isEmpty() && DOXY_CONFIG_GET_BOOL("BRIEF_MEMBER_DESC"))
              {
