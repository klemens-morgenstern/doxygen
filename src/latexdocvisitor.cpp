...
void LatexDocVisitor::visit(DocVerbatim *s)
{
  ...
  switch(s->type())
  {
    ...
    case DocVerbatim::Dot: 
      {
        ...
        fileName.sprintf("%s%d%s", 
            (DOXY_CONFIG_GET_STRING("LATEX_OUTPUT")+"/inline_dotgraph_").data(), 
            dotindex++,
            ".dot"
           );
        QFile file(fileName);
    ...
    case DocVerbatim::Msc: 
      {
        ...
        baseName.sprintf("%s%d", 
            (DOXY_CONFIG_GET_STRING("LATEX_OUTPUT")+"/inline_mscgraph_").data(), 
            mscindex++
           );
    ...
    case DocVerbatim::PlantUML: 
      {
        QCString latexOutput = DOXY_CONFIG_GET_STRING("LATEX_OUTPUT");
...
void LatexDocVisitor::visit(DocAnchor *anc)
{
  ...
  if (!anc->file().isEmpty() && DOXY_CONFIG_GET_BOOL("PDF_HYPERLINKS")) 
  {
...
void LatexDocVisitor::visitPre(DocXRefItem *x)
{
  ...
  m_t << "\\item[";
  if (DOXY_CONFIG_GET_BOOL("PDF_HYPERLINKS") && !anonymousEnum)
  {
                                  ...
                                  )
{
  ...
  QCString outDir = DOXY_CONFIG_GET_STRING("LATEX_OUTPUT");
